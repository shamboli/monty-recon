...
class MatrixBotAPI:
    ...
    def handle_invite(self, room_id, state):
        ...
        print("Got invite to room: {} by {}.".format(str(room_id), inviting_user))
        ...
        if [user for user in users if re.match(inviting_user, user)]:
            print("Accepting invite from {}. Joining room.".format(inviting_user))
            ...
            print("Not accepting invite from: {}. Add to user_whitelist.txt to enable access.".format(inviting_user))
